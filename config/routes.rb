Rails.application.routes.draw do
  ...
  get 'dashboard/analytics/channels', to: 'admin#analytics_channels'
  post 'dashboard/analytics/campaign_name', to: 'admin#analytics_campaign_name'
  post 'dashboard/analytics/ad_spend', to: 'admin#analytics_ad_spend'
