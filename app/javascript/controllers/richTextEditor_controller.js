...
// Trix is loaded as a UMD script in layouts/dashboard.erb, where its block
// attributes are configured so content headings start at h2 (the page's own
// <h1> is generated by the view). The select below maps onto that config.
export default class extends Controller {
  ...
  addHeadingControls() {
    ...
    headingSelect.innerHTML = `
      ...
      <option value="heading1">Titlu secțiune (H2)</option>
      <option value="sub-heading">Subtitlu (H3)</option>
      <option value="heading3">Titlu mic (H4)</option>
    `;
