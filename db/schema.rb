...
ActiveRecord::Schema[8.0].define(version: 2026_09_26_090000) do
  ...
  create_table "ad_campaign_names", force: :cascade do |t|
    t.string "campaign_id", null: false
    t.string "name", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["campaign_id"], name: "index_ad_campaign_names_on_campaign_id", unique: true
  end

  create_table "ad_spends", force: :cascade do |t|
    t.date "month", null: false
    t.string "channel", default: "paid_google", null: false
    t.decimal "amount", precision: 10, scale: 2, default: "0.0", null: false
    t.string "note"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["month", "channel"], name: "index_ad_spends_on_month_and_channel", unique: true
  end
  ...
  create_table "slug_redirects", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["sluggable_type", "old_slug"], name: "index_slug_redirects_on_sluggable_type_and_old_slug", unique: true
  end
